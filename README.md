...
Only in case of severe bugs I will immediately pause affected game functions, resolve potential item-, resource or money misallocation and after fixing the bug(s) I will request a contract update with the block producers. After launch I will reevaluate adding a bug bounty.
